...
// Source: github.com/wetware/ww/pkg/cluster (interfaces: Announcer,EpochController,PeerSet)
...
// MockEpochController is a mock of EpochController interface
type MockEpochController struct {
	ctrl     *gomock.Controller
	recorder *MockEpochControllerMockRecorder
}

// MockEpochControllerMockRecorder is the mock recorder for MockEpochController
type MockEpochControllerMockRecorder struct {
	mock *MockEpochController
}

// NewMockEpochController creates a new mock instance
func NewMockEpochController(ctrl *gomock.Controller) *MockEpochController {
	mock := &MockEpochController{ctrl: ctrl}
	mock.recorder = &MockEpochControllerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockEpochController) EXPECT() *MockEpochControllerMockRecorder {
	return m.recorder
}

// Advance mocks base method
func (m *MockEpochController) Advance(arg0 time.Time) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Advance", arg0)
}

// Advance indicates an expected call of Advance
func (mr *MockEpochControllerMockRecorder) Advance(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Advance", reflect.TypeOf((*MockEpochController)(nil).Advance), arg0)
}
