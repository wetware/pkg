...
//
//	mockgen -source=routing.go -destination=test/routing.go -package=test_routing
//

// Package test_routing is a generated GoMock package.
package test_routing
...
func (mr *MockSnapshotMockRecorder) Get(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSnapshotMockRecorder) GetReverse(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSnapshotMockRecorder) LowerBound(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSnapshotMockRecorder) ReverseLowerBound(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
