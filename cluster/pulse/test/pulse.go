...
//
//	mockgen -source=pulse.go -destination=test/pulse.go -package=test_pulse
//
...
import (
	...
	pulse "github.com/wetware/pkg/cluster/pulse"
...
func (mr *MockPreparerMockRecorder) Prepare(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
