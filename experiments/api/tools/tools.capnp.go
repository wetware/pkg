...
func (s Tools_http_Results) Getter() http.HttpGetter {
	p, _ := capnp.Struct(s).Ptr(0)
	return http.HttpGetter(p.Interface().Client())
}

func (s Tools_http_Results) HasGetter() bool {
	return capnp.Struct(s).HasPtr(0)
}

func (s Tools_http_Results) SetGetter(v http.HttpGetter) error {
	if !v.IsValid() {
...
func (p Tools_http_Results_Future) Getter() http.HttpGetter {
	return http.HttpGetter(p.Future.Field(0, nil).Client())
}

const schema_9462f07b5ef19869 = "x\xda\x12X\xee\xc0b\xc8{\x9e\x99\x81)P\x87\x95" +
	"\xed\xff\xbb\xbdf\x06\xfc\x9b\xe5f1\x08\x0a120" +
	"\xb0\xb030\x08\x9fe\xfc\xc4\xc0\xf2\x9f%\xf6U\xf5" +
	"\xb7\xb8\xba-\x10\x09VF\x90\xccF\xc6_\x0c\x8c\xc2" +
	"[\x19\xed\x19\x18\xff\x1b\xde_\xf3\x8bSL\xe90\x83" +
	" \x0f\xf3\xff\xcc\x19\x1f\xe3\xaa?$Ma``\x14" +
	"\xbe\xca8I\xf8.X\xf9MFwaF&v\x86" +
	"\x88\xff%\xf9\xf99\xc5z\xc9\x89L\x05y\x05V!" +
	"`NFII\x81J\x80|bQbn1N\xf9" +
	" \xfb\xd4\xe2\xd2\x9c\x92\xe2@\x16f\x16\x06\x06\x16F" +
	"\x06\x06A^+\x06\x86@\x0ef\xc6@\x11&F\xfb" +
	"\xf4\xd4\x92\x92\xd4\"F\xc1\xff\x196\xfbf\xbd_3" +
	"\xe3\x0f\x03\x03#\xa3 \x03#\xdc@F\x98\x81\x8c\xc5" +
	"\x01\x8c\x8c\x81,\xcc\xac\x0c\x0cp?3\xc2\xfc((" +
	"\xa8\xc5\xc0$\xc8\xca\xce\x0f\xb2\xd4\x811\x80\x91\x11\x10" +
	"\x00\x00\xff\xff_\xf0X\x0b"
